...
/// Native private-directory storage for catalog packs.
class ExampleModelStorage implements WebAssetReader, WebAssetWriter {
  /// Creates storage that talks to the example method channel.
  ...
  /// Returns the private model root supplied by the native example host.
  ...
  /// Returns remaining bytes reported by the native host.
  ...
  /// Directory reserved for [option] under the private root.
  ...
  /// Removes the private copy of [option] and clears a matching selection.
  ...
  @override
  Future<List<int>?> read(String key) async => null;

  @override
  Future<void> write(String key, List<int> bytes) async {
    throw const ExampleStorageException(
      'Native example storage does not write through the web asset writer.',
    );
  }
