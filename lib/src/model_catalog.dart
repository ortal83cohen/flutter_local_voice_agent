...
final class VoiceModelOption {
  ...
  /// Documented speaker count for this synthesis voice. LJS is 1; VCTK is 109.
...
abstract final class VoiceModelCatalog {
  /// Compact LJS first, then full-precision LJS, then compact VCTK.
  static final List<VoiceModelOption> entries = List.unmodifiable([
        ...
        files: [
          ModelDownload(
            entry: ModelFileEntry(
              ...
              source: 'https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models#asset-silero_vad.onnx-id-271935959',
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              source: 'https://huggingface.co/csukuangfj/sherpa-onnx-streaming-zipformer-en-2023-06-26/tree/672fbf1b30579d6585301139bb363f42a0ad4a24',
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              bytes: 37423560,
              sha256: 'b3aa88de0202a040d7d75bac9dbf1a59d81d60c7369046f32241afa7dec65cc1',
              source: 'https://huggingface.co/csukuangfj/vits-ljs/tree/7ac337c834f318e45a34037cb3371cc3929187ff',
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              source: 'https://github.com/snakers4/silero-vad/blob/60b7ffa243625ebdc1070275a29f18c87843786a/LICENSE',
              license: 'licenses/silero-vad-LICENSE',
            ),
            uri: Uri.parse(
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              bytes: 216,
              sha256: 'c914dd28e23310a6dd345ea10495003d3e4820d2ed987181e4c2d67e501b6b76',
              source: 'https://huggingface.co/csukuangfj/sherpa-onnx-streaming-zipformer-en-2023-06-26/blob/672fbf1b30579d6585301139bb363f42a0ad4a24/README.md',
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              bytes: 526,
              sha256: '26711a83b9cfccab716b482512ee95f53de9aaf68c3a3c4400c789ab52892a3c',
              source: 'https://huggingface.co/csukuangfj/vits-ljs/blob/7ac337c834f318e45a34037cb3371cc3929187ff/README.md',
              license: 'licenses/apache-2.0.txt',
            ),
            uri: Uri.parse(
    ...
    VoiceModelOption(
      ...
      description: 'Full-precision speech models with the same LJS English voice. Larger download.',
      language: 'English (US)',
      speakerCount: 1,
      descriptor: ModelPackDescriptor(
        ...
        files: [
          ...
          ModelDownload(
            entry: ModelFileEntry(
              ...
              bytes: 262127043,
              sha256: 'a423883ce5754507fd941755ab0b5bc426a84ac670cbe21cf060e9e2c66dc660',
              source: 'https://huggingface.co/csukuangfj/sherpa-onnx-streaming-zipformer-en-2023-06-26/tree/672fbf1b30579d6585301139bb363f42a0ad4a24',
              license: 'licenses/zipformer-README.md',
            ),
            uri: Uri.parse(
    ...
    VoiceModelOption(
      title: 'English compact VCTK (INT8)',
      description: 'Smaller INT8 speech models with the VCTK English multi-speaker voice.',
      language: 'English (US)',
      speakerCount: 109,
      descriptor: ModelPackDescriptor(
        id: 'en-us-vctk-zipformer-int8',
        version: 'zipformer-672fbf1-vits-5d7d647',
        files: [
          ModelDownload(
            entry: ModelFileEntry(
              role: 'vad',
          ...
          ModelDownload(
            entry: ModelFileEntry(
              role: 'ttsModel',
              path: 'tts/vits-vctk.int8.onnx',
              bytes: 39240108,
              sha256: 'fce6a16ccab9a99910fe60d6d3c95163ff98cd9043dcfc223371a1f208ffaafd',
              source: 'https://huggingface.co/csukuangfj/vits-vctk/tree/5d7d647d6ea0f6206544735d74b25d3877c0f9ca',
              license: 'licenses/vits-vctk-README.md',
            ),
            uri: Uri.parse(
              'https://huggingface.co/csukuangfj/vits-vctk/resolve/5d7d647d6ea0f6206544735d74b25d3877c0f9ca/vits-vctk.int8.onnx',
            ),
          ),
          ModelDownload(
            entry: ModelFileEntry(
            ...
            uri: Uri.parse(
              'https://huggingface.co/csukuangfj/vits-vctk/raw/5d7d647d6ea0f6206544735d74b25d3877c0f9ca/tokens.txt',
            ),
          ),
          ModelDownload(
            entry: ModelFileEntry(
            ...
            uri: Uri.parse(
              'https://huggingface.co/csukuangfj/vits-vctk/raw/5d7d647d6ea0f6206544735d74b25d3877c0f9ca/lexicon.txt',
            ),
          ),
          ModelDownload(
            entry: ModelFileEntry(
          ...
          ModelDownload(
            entry: ModelFileEntry(
              role: 'license',
              path: 'licenses/vits-vctk-README.md',
              bytes: 536,
              sha256: 'a3780082ea5c79b5fa0e159efea06c26569bf27bcbdb19aec545af766aaf8f37',
              source: 'https://huggingface.co/csukuangfj/vits-vctk/blob/5d7d647d6ea0f6206544735d74b25d3877c0f9ca/README.md',
              license: 'licenses/apache-2.0.txt',
            ),
            uri: Uri.parse(
              'https://huggingface.co/csukuangfj/vits-vctk/raw/5d7d647d6ea0f6206544735d74b25d3877c0f9ca/README.md',
            ),
          ),
          ModelDownload(
            entry: ModelFileEntry(
