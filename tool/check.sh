...
python3 tool/test_native.py; echo 'Stage 5 passed: tests'
dart pub publish --dry-run; echo 'Stage 6 passed: package dry run'
sh tool/test_bump_patch_version.sh; sh tool/test_occupied_pubdev_versions.sh; echo 'Stage 7 passed: release helper tests'
